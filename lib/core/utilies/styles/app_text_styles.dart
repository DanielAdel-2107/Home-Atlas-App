...
import 'package:rental_app/core/helper/get_responsive_font_size.dart';
...
class AppTextStyles {
  ...
  static TextStyle title16LightGreyW500 = TextStyle(
  ...
  static TextStyle title20Black400 = TextStyle(
    color: Colors.black,
    fontSize: getResponsiveFontSize(fontSize: 20),
    fontWeight: FontWeight.w400,
  );
  ...
  static TextStyle title18RedColorW500 = TextStyle(
    color: Colors.red,
    fontSize: getResponsiveFontSize(fontSize: 18),
    fontWeight: FontWeight.w500,
  );
