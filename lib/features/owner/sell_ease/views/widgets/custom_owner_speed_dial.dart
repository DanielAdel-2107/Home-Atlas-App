...
class CustomOwnerSpeedDial extends StatelessWidget {
  const CustomOwnerSpeedDial({super.key});
    ...
    return SpeedDial(
      ...
      children: [
        customSpeedDialChild(
            title: 'Logout',
            onTap: () async {
              getIt<CacheHelper>().removeData(key: "user");
        ...
        customSpeedDialChild(
            ...
            onTap: () async {
              ...
              context.pushScreen(RouteNames.profileScreen, arguments: user.toJson());
            },
            icon: Icons.person),
        customSpeedDialChild(
            title: 'My Houses',
            onTap: () {
              context.pushScreen(RouteNames.myHousesScreen);
            },
            icon: Icons.house),
      ],
    );
