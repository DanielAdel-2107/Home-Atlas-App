...
import 'package:rental_app/features/splash/views/widgets/list_your_proparety_on_boarding_step.dart';
import 'package:rental_app/features/splash/views/widgets/get_started_on_boarding_step.dart';
import 'package:rental_app/features/splash/views/widgets/renter_on_boarding_step.dart';
import 'package:rental_app/features/splash/views/widgets/chat_negotiate_on_boarding_step.dart.dart';
...
class OnBoardingScreenCubit extends Cubit<OnBoardingScreenState> {
  ...
  final List<Widget> onBoardingSteps = [
    ...
    BrowsePropertiesOnBoardingStep(),
    ListYourProparetyOnBoardingStep(),
    ChatAndNegotiateOnBoardingStep(),
